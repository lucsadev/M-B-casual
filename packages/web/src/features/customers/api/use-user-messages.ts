/**
 * User Messages — API and TanStack Query hooks for customer messages.
 *
 * Provides:
 * - sendOrderMessage — insert a message from admin to customer
...
import type { Message, CreateMessageInput } from '@mbt/shared';
...
// ---------------------------------------------------------------------------
// Mutation: send a message (admin only, called from order status change)
// ---------------------------------------------------------------------------

export async function sendOrderMessage(input: CreateMessageInput): Promise<void> {
