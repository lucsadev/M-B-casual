...
function IconPointOfSale({ active }: { active: boolean }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="18"
...
const NAV_ITEMS: NavItem[] = [
  ...
  { to: '/admin/ventas-presencial', label: 'Ventas presencial', end: false, Icon: IconPointOfSale },
  { to: '/admin/compras', label: 'Compras', end: false, Icon: IconPurchase },
  { to: '/admin/gastos', label: 'Gastos', end: false, Icon: IconExpense },
  { to: '/admin/configuracion', label: 'Configuración', end: false, Icon: IconSettings },
...
const ROUTE_LABELS: Record<string, string> = {
  ...
  clientes: 'Usuarios',
  preguntas: 'Preguntas',
  'ventas-presencial': 'Ventas presencial',
  compras: 'Compras',
  gastos: 'Gastos',
